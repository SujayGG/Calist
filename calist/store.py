...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "stage_templates": {
        "essay": [
            {"name": "draft", "weight": 0.55, "awaits_days": 2},
            {"name": "revise", "weight": 0.35, "gap_days_after": 1},
            {"name": "polish", "weight": 0.10},
        ],
        "schoolwork": [{"name": "work", "weight": 1.0}],
        "admin": [{"name": "do", "weight": 1.0}],
        "build": [{"name": "build", "weight": 1.0}],
        "test": [
            {"name": "review-1", "weight": 0.2, "gap_days_after": 2},
            {"name": "review-2", "weight": 0.2, "gap_days_after": 2},
            {"name": "review-3", "weight": 0.25, "gap_days_after": 1},
            {"name": "cram", "weight": 0.35},
        ],
    },
    "watch": {
        "dwell_minutes": 7,
